    ...
    <div className="home-page">
      ...
      <section className="cta-section">
        <div className="cta-content container text-center">
          <span className="hero-badge fade-in" style={{ letterSpacing: '0.15em', marginBottom: '14px' }}>✦ Discover Luxury ✦</span>
          ...
          <p className="slide-up delay-1" style={{ maxWidth: '560px', margin: '0 auto 20px' }}>
            Explore our curated luxury collections of exquisite fragrances and find the perfect match for your style.
          </p>
