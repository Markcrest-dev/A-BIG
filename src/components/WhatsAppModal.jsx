    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content wa-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="wa-header" style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <p className="wa-product-name" style={{ color: 'var(--gold-light)', fontWeight: 600, fontSize: '1.05rem', marginTop: '6px' }}>{product.name}</p>
        </div>
        <p className="wa-subtitle" style={{ textAlign: 'center', marginBottom: '20px' }}>Choose a number to place your order:</p>
        <div className="wa-buttons">
          {numbers.map(n => (
            ...
            >
              <span className="wa-whatsapp-icon" style={{ display: 'flex', alignItems: 'center' }}>
